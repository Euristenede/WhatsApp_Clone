...
class _MensagensState extends State<Mensagens> {
  ...
  _enviarFoto() async {
    ...
    _subindoImagen = true;
    String nomeImagen = DateTime.now().millisecondsSinceEpoch.toString();
    FirebaseStorage storage = FirebaseStorage.instance;
    Reference pastaRaiz = storage.ref();
    Reference arquivo = pastaRaiz
        .child("mensagens")
        .child(_idUsuarioLogado)
        .child(nomeImagen + ".jpg");
                ...
                return Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, indice) {
                          ...
                          Alignment alinahmento = Alignment.centerRight;
                          Color cor = Color(0xffd2ffa5);
                          if (_idUsuarioLogado != item["idUsuario"]) {
                            alinahmento = Alignment.centerLeft;
                            cor = Colors.white;
                          }
                          return Align(
                              alignment: alinahmento,
                              child: Padding(
